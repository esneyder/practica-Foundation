  ...
  <body>
    ...
    <div class="row">
      ...
      if ($mensaje == 4) {
        echo " 
          <div data-alert class='alert-box warning  radius'>
      Registro no se pudo actualizar
      <a href='#' class='close'>&times;</a>
    </div>
    ...
    <div class="small-8 columns">
      <div class="row">
        ...
        <div class="small-9 columns">
          <input type="text" id="right-label" placeholder="Nombre" name="nombre" required  >
       ...
       <div class="row" >
        ...
        <div class="small-9 columns">
          <input type="text" id="right-label" placeholder="Apellido" name="apellido" required >
       ...
       <div class="row">
        ...
        <div class="small-9 columns">
          <input type="text" id="right-label" placeholder="Dirección" name="direccion" required  >
        </div>
      </div>
       <div class="row">
        <div class="small-3 columns">
        ...
        <div class="small-9 columns">
          <input type="text" id="right-label" placeholder="Teléfono" name="telefono" required >
        </div>
      </div>
       <div class="row">
        <div class="small-3 columns">
        ...
        <div class="small-9 columns">
          <input type="text" id="right-label" placeholder="Ciudad" name="ciudad" required  >
        </div>
      </div>
      <di class="row">
        <div class="small-9 columns">
     ...
     <div class="large-12 columns">
        ...
        <div class="panel">
          ...
          <a href="http://ingneyder.tk" class="small button warning" target="_blank" >Pagina</a> 
